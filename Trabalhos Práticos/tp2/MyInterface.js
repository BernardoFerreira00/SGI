...
export class MyInterface extends CGFinterface {
    ...
    processKeyDown(event) {
        ...
        // Verify if pressed key is 'M'.
        // If yes, indicates that materials need to change.
        // Supports functionality to change component's material trough keyboard. 
        if (event.code == "KeyM")
            this.scene.toChangeMaterial = true
