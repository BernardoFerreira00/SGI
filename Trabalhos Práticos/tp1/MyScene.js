...
export class MyScene extends CGFscene {
    ...
    initLights() {
        ...
        this.lights[1].setSpecular(4.8, 3.48, -0.2, 1.0);
        this.lights[1].enable();
        this.lights[1].setVisible(true);
        this.lights[1].update();
    ...
    initMaterials() {
        ...
        this.wood1Material.setAmbient(0.36, 0.16, 0.02, 1.0);
        this.wood1Material.setDiffuse(0.36, 0.16, 0.02, 1.0);
        this.wood1Material.setSpecular(1, 1, 1, 1);
        this.wood1Material.setShininess(100.0);
        ...
        this.wood2Material.setSpecular(0.1, 0.1, 0.1, 0.1);
        ...
        this.wallMaterial.setSpecular(0.1, 0.1, 0.1, 0.1);
        ...
        this.floorMaterial.setSpecular(0.1, 0.1, 0.1, 0.1);
